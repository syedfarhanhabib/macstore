        ...
        <>
            {storeCard.map((item, index) => (
                <React.Fragment key={index} >
                    <Dialog>
                        <DialogContent className='h-[80vh] w-[80vw] overflow-y-auto max-w-[90vw] max-h-[90vh]' >
                            <Tabs>
                                ...
                                <TabsContent value={item.title} className='w-full  rounded-5xl pt-16 flex flex-col md:flex-row gap-10' >
                                    <div className="w-full flex gap-20 justify-between">
                                        <div className="relative left w-1/3">
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center center w-fit h-4 z-10">
                                                    <CarouselNext />
                                                    <CarouselPrevious />
                                                </div>
                                            </Carousel>
                                        ...
                                        <div className="right w-2/3 flex flex-col">
                                            ...
                                            <div className="dialogContent">
                                                <div className="left w-1/12">
                                                    <i className='text-5xl' >{item.data.img2}</i>
                                                </div>
                                            ...
                                            <div className="dialogContent">
                                                <div className="left w-1/12">
                                                    <i className='text-5xl' >{item.data.img3}</i>
                                                </div>
                                                <div className='w-[1px] h-full dark:bg-muted bg-muted-foreground' />
                                                <div className="right w-11/12">
                                            ...
                                            <div className="dialogContent">
                                                <div className="left w-1/12">
                                                    <i className='text-5xl' >{item.data.img4}</i>
                                                </div>
                                                <div className='w-[1px] h-full dark:bg-muted bg-muted-foreground' />
                                                <div className="right w-11/12">
                                            ...
                                            <div className="dialogContent">
                                                <div className="left w-1/12">
                                                    <i className='text-5xl' >{item.data.img5}</i>
                                                </div>
                                                <div className='w-[1px] h-full dark:bg-muted bg-muted-foreground' />
                                                <div className="right w-11/12">
