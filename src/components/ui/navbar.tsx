            ...
            <div className="wrapper flex items-center justify-between">
                <nav className='flex items-center gap-5' >
                    ...
                    <ul className=' items-center gap-0 hidden md:flex' >
                        <Link href={"/store"} ><li><Button variant={"link"} size={"sm"}>Store</Button></li></Link>
                        <Link href={"/"} ><li><Button variant={"link"} size={"sm"}>Accesories</Button></li></Link>
                        <Link href={"/"} ><li><Button variant={"link"} size={"sm"}>Support</Button></li></Link>
                    </ul>
                    <Button
                ...
                <nav className='flex items-center gap-3' >
                    {/* <ThemeSwitch /> */}
                    <Link href={"/"}><Button variant={"ghost"} size={"icon"} ><BiSearch size={16} /></Button></Link>
                    <Link href={"/"}><Button variant={"ghost"} size={"icon"} ><BiCart size={16} /></Button></Link>
                </nav>
            </div>
            {menu && (
